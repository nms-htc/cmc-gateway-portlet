 ...
 */
public class ProvisioningActionLocalServiceClp
	implements ProvisioningActionLocalService {
	public ProvisioningActionLocalServiceClp(
	...
	public com.cmc.gateway.domain.model.ProvisioningAction addProvisioningAction(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(provisioningAction)
					});
		}
		catch (Throwable t) {
		...
		return (com.cmc.gateway.domain.model.ProvisioningAction)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.cmc.gateway.domain.model.ProvisioningAction> getProvisioningActions(
		...
		return (java.util.List<com.cmc.gateway.domain.model.ProvisioningAction>)ClpSerializer.translateOutput(returnObj);
	}

...
/**
 * The base implementation of the command action local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.CommandActionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CommandActionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CommandActionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.CommandActionLocalServiceUtil} to access the command action local service.
	 */
	...
	public CommandAction addCommandAction(CommandAction commandAction)
		throws SystemException {
		commandAction.setNew(true);

		return commandActionPersistence.update(commandAction, false);
	}
	 ...
	 */
	public CommandAction createCommandAction(long actionId) {
		return commandActionPersistence.create(actionId);
	}
	...
	public CommandAction deleteCommandAction(long actionId)
		throws PortalException, SystemException {
		return commandActionPersistence.remove(actionId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CommandAction deleteCommandAction(CommandAction commandAction)
		throws SystemException {
		return commandActionPersistence.remove(commandAction);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CommandAction.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return commandActionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return commandActionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CommandAction fetchCommandAction(long actionId)
		throws SystemException {
		return commandActionPersistence.fetchByPrimaryKey(actionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CommandAction getCommandAction(long actionId)
		throws PortalException, SystemException {
		return commandActionPersistence.findByPrimaryKey(actionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return commandActionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CommandAction> getCommandActions(int start, int end)
		throws SystemException {
		return commandActionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCommandActionsCount() throws SystemException {
		return commandActionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CommandAction updateCommandAction(CommandAction commandAction)
		throws SystemException {
		return updateCommandAction(commandAction, true);
	}
	...
	public CommandAction updateCommandAction(CommandAction commandAction,
		...
		return commandActionPersistence.update(commandAction, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.CommandAction",
			commandActionLocalService);
	}
	...
	private CommandActionLocalServiceClpInvoker _clpInvoker = new CommandActionLocalServiceClpInvoker();
}
...
/**
 * The base implementation of the provisioning message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.ProvisioningMessageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProvisioningMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProvisioningMessageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.ProvisioningMessageLocalServiceUtil} to access the provisioning message local service.
	 */
	...
	public ProvisioningMessage addProvisioningMessage(
		ProvisioningMessage provisioningMessage) throws SystemException {
		provisioningMessage.setNew(true);

		return provisioningMessagePersistence.update(provisioningMessage, false);
	}
	 ...
	 */
	public ProvisioningMessage createProvisioningMessage(long messageId) {
		return provisioningMessagePersistence.create(messageId);
	}
	...
	public ProvisioningMessage deleteProvisioningMessage(long messageId)
		throws PortalException, SystemException {
		return provisioningMessagePersistence.remove(messageId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProvisioningMessage deleteProvisioningMessage(
		ProvisioningMessage provisioningMessage) throws SystemException {
		return provisioningMessagePersistence.remove(provisioningMessage);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProvisioningMessage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return provisioningMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return provisioningMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProvisioningMessage fetchProvisioningMessage(long messageId)
		throws SystemException {
		return provisioningMessagePersistence.fetchByPrimaryKey(messageId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ProvisioningMessage getProvisioningMessage(long messageId)
		throws PortalException, SystemException {
		return provisioningMessagePersistence.findByPrimaryKey(messageId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return provisioningMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ProvisioningMessage> getProvisioningMessages(int start, int end)
		throws SystemException {
		return provisioningMessagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProvisioningMessagesCount() throws SystemException {
		return provisioningMessagePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProvisioningMessage updateProvisioningMessage(
		ProvisioningMessage provisioningMessage) throws SystemException {
		return updateProvisioningMessage(provisioningMessage, true);
	}
	...
	public ProvisioningMessage updateProvisioningMessage(
		...
		return provisioningMessagePersistence.update(provisioningMessage, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.ProvisioningMessage",
			provisioningMessageLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = provisioningMessagePersistence.getDataSource();
	...
	private ProvisioningMessageLocalServiceClpInvoker _clpInvoker = new ProvisioningMessageLocalServiceClpInvoker();
}
...
/**
 * The base implementation of the command entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.CommandEntryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CommandEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CommandEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.CommandEntryLocalServiceUtil} to access the command entry local service.
	 */
	...
	public CommandEntry addCommandEntry(CommandEntry commandEntry)
		throws SystemException {
		commandEntry.setNew(true);

		return commandEntryPersistence.update(commandEntry, false);
	}
	 ...
	 */
	public CommandEntry createCommandEntry(long commandId) {
		return commandEntryPersistence.create(commandId);
	}
	...
	public CommandEntry deleteCommandEntry(long commandId)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CommandEntry deleteCommandEntry(CommandEntry commandEntry)
		throws SystemException {
		return commandEntryPersistence.remove(commandEntry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CommandEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return commandEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return commandEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CommandEntry fetchCommandEntry(long commandId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CommandEntry getCommandEntry(long commandId)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return commandEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CommandEntry> getCommandEntries(int start, int end)
		throws SystemException {
		return commandEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCommandEntriesCount() throws SystemException {
		return commandEntryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CommandEntry updateCommandEntry(CommandEntry commandEntry)
		throws SystemException {
		return updateCommandEntry(commandEntry, true);
	}
	...
	public CommandEntry updateCommandEntry(CommandEntry commandEntry,
		...
		return commandEntryPersistence.update(commandEntry, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.CommandEntry",
			commandEntryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = commandEntryPersistence.getDataSource();
	...
	private CommandEntryLocalServiceClpInvoker _clpInvoker = new CommandEntryLocalServiceClpInvoker();
}
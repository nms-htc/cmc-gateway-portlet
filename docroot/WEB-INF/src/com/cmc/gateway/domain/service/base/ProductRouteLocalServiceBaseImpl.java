...
/**
 * The base implementation of the product route local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.ProductRouteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProductRouteLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductRouteLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.ProductRouteLocalServiceUtil} to access the product route local service.
	 */
	...
	public ProductRoute addProductRoute(ProductRoute productRoute)
		throws SystemException {
		productRoute.setNew(true);

		return productRoutePersistence.update(productRoute, false);
	}
	 ...
	 */
	public ProductRoute createProductRoute(long routeId) {
		return productRoutePersistence.create(routeId);
	}
	...
	public ProductRoute deleteProductRoute(long routeId)
		throws PortalException, SystemException {
		return productRoutePersistence.remove(routeId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProductRoute deleteProductRoute(ProductRoute productRoute)
		throws SystemException {
		return productRoutePersistence.remove(productRoute);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProductRoute.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return productRoutePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productRoutePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProductRoute fetchProductRoute(long routeId)
		throws SystemException {
		return productRoutePersistence.fetchByPrimaryKey(routeId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ProductRoute getProductRoute(long routeId)
		throws PortalException, SystemException {
		return productRoutePersistence.findByPrimaryKey(routeId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productRoutePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ProductRoute> getProductRoutes(int start, int end)
		throws SystemException {
		return productRoutePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProductRoutesCount() throws SystemException {
		return productRoutePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProductRoute updateProductRoute(ProductRoute productRoute)
		throws SystemException {
		return updateProductRoute(productRoute, true);
	}
	...
	public ProductRoute updateProductRoute(ProductRoute productRoute,
		...
		return productRoutePersistence.update(productRoute, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.ProductRoute",
			productRouteLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productRoutePersistence.getDataSource();
	...
	private ProductRouteLocalServiceClpInvoker _clpInvoker = new ProductRouteLocalServiceClpInvoker();
}
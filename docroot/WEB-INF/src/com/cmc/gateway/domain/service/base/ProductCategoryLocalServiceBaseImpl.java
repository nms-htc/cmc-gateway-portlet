...
/**
 * The base implementation of the product category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.ProductCategoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProductCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.ProductCategoryLocalServiceUtil} to access the product category local service.
	 */
	...
	public ProductCategory addProductCategory(ProductCategory productCategory)
		...
		return productCategoryPersistence.update(productCategory, false);
	}
	 ...
	 */
	public ProductCategory createProductCategory(long categoryId) {
		return productCategoryPersistence.create(categoryId);
	}
	...
	public ProductCategory deleteProductCategory(long categoryId)
		...
		return productCategoryPersistence.remove(categoryId);
	}
	...
	public ProductCategory deleteProductCategory(
		ProductCategory productCategory) throws SystemException {
		return productCategoryPersistence.remove(productCategory);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProductCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return productCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProductCategory fetchProductCategory(long categoryId)
		throws SystemException {
		return productCategoryPersistence.fetchByPrimaryKey(categoryId);
	}
	...
	public ProductCategory getProductCategory(long categoryId)
		throws PortalException, SystemException {
		return productCategoryPersistence.findByPrimaryKey(categoryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProductCategory> getProductCategories(int start, int end)
		throws SystemException {
		return productCategoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProductCategoriesCount() throws SystemException {
	...
	public ProductCategory updateProductCategory(
		ProductCategory productCategory) throws SystemException {
		return updateProductCategory(productCategory, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public ProductCategory updateProductCategory(
		ProductCategory productCategory, boolean merge)
		throws SystemException {
		productCategory.setNew(false);

		return productCategoryPersistence.update(productCategory, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.ProductCategory",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productCategoryPersistence.getDataSource();
	...
	private ProductCategoryLocalServiceClpInvoker _clpInvoker = new ProductCategoryLocalServiceClpInvoker();
}
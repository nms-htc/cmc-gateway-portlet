...
/**
 * The base implementation of the product message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmc.gateway.domain.service.impl.ProductMessageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProductMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductMessageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.cmc.gateway.domain.service.ProductMessageLocalServiceUtil} to access the product message local service.
	 */
	...
	public ProductMessage addProductMessage(ProductMessage productMessage)
		throws SystemException {
		productMessage.setNew(true);

		return productMessagePersistence.update(productMessage, false);
	}
	 ...
	 */
	public ProductMessage createProductMessage(long messageId) {
		return productMessagePersistence.create(messageId);
	}
	...
	public ProductMessage deleteProductMessage(long messageId)
		throws PortalException, SystemException {
		return productMessagePersistence.remove(messageId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProductMessage deleteProductMessage(ProductMessage productMessage)
		throws SystemException {
		return productMessagePersistence.remove(productMessage);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProductMessage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return productMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProductMessage fetchProductMessage(long messageId)
		throws SystemException {
		return productMessagePersistence.fetchByPrimaryKey(messageId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ProductMessage getProductMessage(long messageId)
		throws PortalException, SystemException {
		return productMessagePersistence.findByPrimaryKey(messageId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ProductMessage> getProductMessages(int start, int end)
		throws SystemException {
		return productMessagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProductMessagesCount() throws SystemException {
		return productMessagePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProductMessage updateProductMessage(ProductMessage productMessage)
		throws SystemException {
		return updateProductMessage(productMessage, true);
	}
	...
	public ProductMessage updateProductMessage(ProductMessage productMessage,
		...
		return productMessagePersistence.update(productMessage, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.cmc.gateway.domain.model.ProductMessage",
			productMessageLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productMessagePersistence.getDataSource();
	...
	private ProductMessageLocalServiceClpInvoker _clpInvoker = new ProductMessageLocalServiceClpInvoker();
}
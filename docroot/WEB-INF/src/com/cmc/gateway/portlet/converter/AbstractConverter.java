...
public abstract class AbstractConverter<T extends BaseModel<T>> implements
		Converter {
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		if (value.getClass().equals(getModelClass())) {
			...
			throw new IllegalArgumentException("object " + value
					...
					+ "; expected type: " + getModelClass().getName());
		}
	}

	protected abstract T find(String value) throws SystemException,
			PortalException;
